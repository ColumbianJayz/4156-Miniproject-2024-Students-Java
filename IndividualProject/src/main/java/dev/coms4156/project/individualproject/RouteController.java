...
public class RouteController {
   ...
   */
  @GetMapping("/getMajorCountFromDept")
  ...
  /**
   * Sets the enrollment for a course if it exists.
   *
   * @param deptCode The code for the department of the course.
   * @param courseCode The code for the course.
   * @param count The enrollment count for the code.
   * @return A new response entity with a message of whether 
   *     or not "Attributed" was updated successfully.
   */
 ...
 *
 * @param deptCode The code for the department.
 * @param courseCode The code for the course.
 * @param location The location for the course.
 * @return A response entity indicating whether the location was updated successfully.
 */
